...
Sources: [Wikipedia:Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing) for Passes 1–3 and 5–6. Pass 4 additionally draws on [Claudisms](https://claudisms.ai/), Ivo Velitchkov's [22 Claude Clichés](https://www.linkandth.ink/p/catalog-of-claude-cliches), and [Claude Opus 5 Claudisms](https://explainx.ai/blog/claude-opus-5-load-bearing-claudisms-writing-tells-2026), which catalogue the terse register the Wikipedia list does not cover.
...
**Weight-asserting modifiers.** Words that claim a thing carries weight in place of showing what it holds up: load-bearing (figurative), genuinely, structurally, meaningfully, fundamentally, precisely, exactly right, full stop. "Load-bearing" is the most-cited single tell of the current model generation. Keep it only where the load is named.
...
**Editorial insertions.** Announcements that a remark is coming, made instead of the remark: it is important to note that, it should be noted that, it is worth mentioning that, it bears repeating that, notably, importantly, no discussion would be complete without. Delete the frame and keep the sentence. (The plainer, terse-register versions of this move are Pass 4.)
...
- **The announced point.** A preamble that tells the reader what the next sentence is going to be worth — important, precise, overlooked, hard-won — instead of writing the sentence and letting it be worth that. The defect is a division of labor that shouldn't exist: the frame claims the value, the content is supposed to deliver it, and because the frame already banked the claim, the content is free to be thin. Readers grant significance; they don't accept it on assignment. This is the terse-register sibling of the clipped pronouncement above: the pronouncement asserts weight *after* the fact, this one *reserves* it in advance. Four sub-families, all common enough to check by name:
  - *The "worth" family.* "It's worth being precise about", "it's worth noting that", "it's worth stating plainly", "it's worth dwelling on", "worth talking about", "worth sitting with", and the rest of the "worth [gerund]" set. All of them assign merit before the reader has anything to judge.
  - *Promised precision.* "To be precise", "to put a finer point on it", "let's be precise about", "more precisely", "that's right, and it can be made precise". The promise is itself the tell: a writer holding the precise version writes it. Watch for the two-step where a claim is first stamped correct and then a sharper form is promised in the same breath — the sharper form usually never arrives.
  - *Self-ranked claims.* "The most important thing here is", "the deepest point is", "the key insight is", "the real question is", "the cleanest way to think about it is". Ranking your own points does the reader's work badly and asks them to take the ranking on credit.
  - *Structure narration.* "Four caveats belong up front", "two things are worth separating here", "below I'll try to specify". Narrating the shape of an argument instead of arguing. Fine once in a long document; a reflex everywhere else.

  Test: delete the frame and keep what follows. If the surviving sentence carries the point, the frame was throat-clearing — this is the usual outcome. If deleting it leaves nothing, the frame *was* the content, and the fix is to supply the distinction it promised rather than restore the preamble.
- **The narrated speech act.** A clause that describes the act of saying something instead of saying it: "and want to be explicit about the second", "let me be clear", "I want to name this directly", "in the interest of full disclosure". It is stage direction that has wandered into the script. The clause carries no information, and because candor is usually what gets narrated, it also claims a virtue the sentence has not yet demonstrated — explicitness is exhibited by the next clause or not at all. Watch for: *want to be explicit/clear about*, *let me be clear*, *to be transparent*, *I'll flag that*, *I want to call out*, *I should say plainly*, *I won't sugarcoat this*, *for full transparency*, *I'd be remiss not to mention*. Verbs of intention — *want to*, *let me*, *I should* — are the reliable marker, because they insert a step between the writer and the act. Unlike most of Pass 4 this one rarely opens a sentence; it hides in a trailing clause after "and", so search the ends of sentences too. Neighbors: the announced point claims the next sentence is valuable, this one claims the writer is being brave in producing it; admission-that-admits-nothing withholds the fact entirely, while here the fact does arrive and only the announcement in front of it is empty.

  Test: cut the clause and keep the disclosure. "I corrected myself twice mid-investigation and want to be explicit about the second" becomes "I corrected myself twice mid-investigation. The second: …". Nothing is lost, because the explicitness was always going to live in what follows.
...
- **An announced point survives when the announcement is doing work.** "It's worth being precise about" earns its place where a real ambiguity is about to be resolved and the reader needs the signal that a distinction — not a restatement — is coming: "It's worth being precise about *deploy* here: rules and functions ship together on the `main` merge, and separately on `develop` they ship not at all." The frame survives because the sentence after it changes what the reader believed. Cut it wherever the following sentence merely continues. Same for structure narration in a genuinely long document, where a reader who needs a map gets one. A narrated speech act survives on the same terms: "to be clear, I did not deploy this" earns its place when it heads off an inference the reader is actively drawing, and not when it merely introduces the next thing.
